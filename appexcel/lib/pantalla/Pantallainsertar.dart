...
class Pantallainsertar extends StatelessWidget {
  @override
                  ...
                  Expanded(
                    child: Padding(
                      ...
                      child: Column(
                        children: <Widget>[
                          Text(
                            "Forma parte de la cinta de opciones de Excel y se encarga de todos los comandos que permiten insertar algún objeto o elemento dentro de un documento, tales como gráficos, tablas, imágenes, texto, y más.",
                            maxLines: 7,
                            style: TextStyle(
                              fontSize: 10,
                              color: KlightBlackColor,
